    ...
    public class BKGrowthModel : GrowthModel
    {
        ...
        public override ExplainedNumber CalculateSettlementCap(Settlement settlement, PopulationData data, bool descriptions = false)
        {
            ...
            if (town != null)
            {
                ...
                {
                    var walls = settlement.Town.Buildings.First(x => x.BuildingType == DefaultBuildingTypes.CastleFortifications);
                    result.Add(walls.CurrentLevel * 1500f, DefaultBuildingTypes.CastleFortifications.Name);
                }

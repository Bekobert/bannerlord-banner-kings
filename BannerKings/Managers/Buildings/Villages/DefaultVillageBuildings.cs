...
namespace BannerKings.Managers.Populations.Villages
{
    public class DefaultVillageBuildings : DefaultTypeInitializer<DefaultVillageBuildings, BuildingType>
    {
        ...
        public override void Initialize()
        {
            ...
            DailyProduction.InitializeDailyProject(new TextObject("{=eMZikYJ3}Production"),
            ...
            DailyFarm.InitializeDailyProject(new TextObject("{=K4xNbbUN}Farmland"),
            ...
            DailyPasture.InitializeDailyProject(new TextObject("{=WPcgsL9J}Pastureland"),
            ...
            DailyWoods.InitializeDailyProject(new TextObject("{=FRAS5TAC}Woodland"),

...
namespace BannerKings.Managers.Institutions.Religions.Faiths.Rites.Northern
{
    public class AxeOffering : WeaponOffering
    {
        ...
        public override void Complete(Hero actionTaker)
        {
            ...
            MBInformationManager.AddQuickInformation(new TextObject("{=LmkLMoVf}The {ITEM} was offered to Pérkos, Thunder Wielder.")
        ...
        public override TextObject GetName() => new TextObject("{=v7tGeXES}Axe of Pérkos");

        public override void SetDialogue()
        {
            MBTextManager.SetTextVariable("CLERGYMAN_RITE_CONFIRM",
                new TextObject("{=G5o9j5gW}{?PLAYER.GENDER}My lady{?}My lord{\\?}, the spirits teach us a blade is a virtuous offering for the Gods. The best its craftsmanship is, the more it pleases the Gods, as only the best man can craft is worthy of them."));
        }
    }
}

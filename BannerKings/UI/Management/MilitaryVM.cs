        ...
        public override void RefreshValues()
        {
            ...
            else
            {
                    ...
                    delegate
                {
                    ...
                    {
                        var existingParty = TaleWorlds.CampaignSystem.Campaign.Current.CampaignObjectManager.FindFirst<MobileParty>(x => x.StringId == "raisedmilitia_" + settlement.StringId);
